...
const messages_poll_1 = require("./messages-poll");
const MIMETYPE_MAP = {
    image: 'image/jpeg',
    video: 'video/mp4',
...
const generateWAMessageContent = async (message, options) => {
    ...
    if ('text' in message) {
        ...
        m.messageContextInfo = {
            messageSecret: (0, crypto_1.randomBytes)(32), // encKey
        };
 ...
 */
const getPollUpdateMessage = async (msg, pollCreationData, withSelectedOptions = false) => {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q;
    if (!((_a = msg.message) === null || _a === void 0 ? void 0 : _a.pollUpdateMessage) || !(pollCreationData === null || pollCreationData === void 0 ? void 0 : pollCreationData.encKey)) {
        throw new boom_1.Boom('Missing pollUpdateMessage, or encKey', { statusCode: 400 });
    }
    pollCreationData.sender = ((_d = (_c = (_b = msg.message) === null || _b === void 0 ? void 0 : _b.pollUpdateMessage) === null || _c === void 0 ? void 0 : _c.pollCreationMessageKey) === null || _d === void 0 ? void 0 : _d.participant) || pollCreationData.sender;
    if (!((_e = pollCreationData.sender) === null || _e === void 0 ? void 0 : _e.length)) {
        throw new boom_1.Boom('Missing sender', { statusCode: 400 });
    }
    let hash = await (0, messages_poll_1.decryptPollMessageRaw)(pollCreationData.encKey, // encKey
    (_h = (_g = (_f = msg.message) === null || _f === void 0 ? void 0 : _f.pollUpdateMessage) === null || _g === void 0 ? void 0 : _g.vote) === null || _h === void 0 ? void 0 : _h.encPayload, // enc payload
    (_l = (_k = (_j = msg.message) === null || _j === void 0 ? void 0 : _j.pollUpdateMessage) === null || _k === void 0 ? void 0 : _k.vote) === null || _l === void 0 ? void 0 : _l.encIv, // enc iv
    (0, WABinary_1.jidNormalizedUser)(pollCreationData.sender), // sender
    (_p = (_o = (_m = msg.message) === null || _m === void 0 ? void 0 : _m.pollUpdateMessage) === null || _o === void 0 ? void 0 : _o.pollCreationMessageKey) === null || _p === void 0 ? void 0 : _p.id, // poll id
    (0, WABinary_1.jidNormalizedUser)(((_q = msg.key.remoteJid) === null || _q === void 0 ? void 0 : _q.endsWith('@g.us')) ?
    ...
    return withSelectedOptions ? {
        hash,
        selectedOptions: await (0, messages_poll_1.comparePollMessage)(pollCreationData.options || [], hash)
    } : { hash };
};
exports.getPollUpdateMessage = getPollUpdateMessage;
