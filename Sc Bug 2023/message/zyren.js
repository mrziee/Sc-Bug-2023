...
//=================================================//
const tzy = { key: {fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "14169948404-1305080833@g.us" } : {}) },"message": {"extendedTextMessage": {"text": "𝙼r Zi𝚎𝚎","previewType": "NONE","contextInfo": {"stanzaId": "3EB0382EDBB2","participant": "6281226416919@s.whatsapp.net" }}}}
const pak = { key: {fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "@s.whatsapp.net" } : {}) },"message": {"extendedTextMessage": {"text": "𝙼r Zi𝚎𝚎️️","previewType": "NONE","contextInfo": {"stanzaId": "3EB0382EDBB2","participant": "@s.whatsapp.net"}}}}
...
const doc = { key: {fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "@s.whatsapp.net" } : {}) },"message": {"documentMessage": {"url": "https://mmg.whatsapp.net/d/f/Aj85sbZCtNtq1cJ6JupaBUTKfgrl2zXRXGvVNWAbFnsp.enc","mimetype": "application/octet-stream","fileSha256": "TSSZu8gDEAPhp8vjdtJS/DXIECzjrSh3rmcoHN76M9k=","fileLength": "64455","pageCount": 1,"mediaKey": "P32GszzU5piUZ5HKluLD5h/TZzubVJ7lCAd1PIz3Qb0=","fileName": `𝙼𝚎𝚕𝚕𝚒𝚊𝙵𝚛𝚒𝚜𝚔𝚊${ngazap(prefix)}`,"fileEncSha256": "ybdZlRjhY+aXtytT0G2HHN4iKWCFisG2W69AVPLg5yk="}}}
const trol = { key: {fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "@s.whatsapp.net" } : {}) },"message": {"orderMessage": {"orderId": "594071395007984","thumbnail": fs.readFileSync("./media/gambarnye/thezyren.jpg"),"itemCount": 100000000000,"status": "INQUIRY","surface": "CATALOG","message": "𝙼𝚎𝚕𝚕𝚒𝚊𝙵𝚛𝚒𝚜𝚔𝚊","orderTitle": "𝙼𝚎𝚕𝚕𝚒𝚊𝙵𝚛𝚒𝚜𝚔𝚊  ","sellerJid": "6281226416919@s.whatsapp.net","token": "AR40+xXRlWKpdJ2ILEqtgoUFd45C8rc1CMYdYG/R2KXrSg==","totalAmount1000": "500000000000000","totalCurrencyCode": "IDR"}}}
const ngetrol = { key: {fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "@s.whatsapp.net" } : {}) },"message": {"orderMessage": {"orderId": "594071395007984","thumbnail": fs.readFileSync("./media/gambarnye/thezyren.jpg"),"itemCount": 100000000000,"status": "INQUIRY","surface": "CATALOG","message": "𝙼𝚎𝚕𝚕𝚒𝚊𝙵𝚛𝚒𝚜𝚔𝚊","orderTitle": "𝙼𝚎𝚕𝚕𝚒𝚊𝙵𝚛𝚒𝚜𝚔𝚊  ${ngazap(prefix)}","sellerJid": "6281226416919@s.whatsapp.net","token": "AR40+xXRlWKpdJ2ILEqtgoUFd45C8rc1CMYdYG/R2KXrSg==","totalAmount1000": "500000000000000","totalCurrencyCode": "IDR" }}}
const ftrolii ={key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "@g.us"},"message": {orderMessage: {itemCount: 100000000000,status: 200, thumbnail: logonya, surface: 200, message: `${ownerName}`,token: "AR40+xXRlWKpdJ2ILEqtgoUFd45C8rc1CMYdYG/R2KXrSg==",totalAmount1000: "500000000000000",totalCurrencyCode: "IDR",orderTitle: `𝙼𝚎𝚕𝚕𝚒𝚊𝙵𝚛𝚒𝚜𝚔𝚊 ${ngazap(prefix)}`,sellerJid: "0@s.whatsapp.net"}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
...
zyren.sendMessage(m.chat, { contextInfo: { mentionedJid: teks? [...teks.matchAll(/@(\d{0,16})/g)].map(v => v[1] + "@s.whatsapp.net") : [], externalAdReply: { showAdAttribution: true, title: "𝙼r Zi𝚎𝚎", body: "DONT CLICK HERE", previewType: "PHOTO", thumbnail: logonya, sourceUrl: "http://youtube.com/@dvsharkyt" }}, text: teks }, { quoted: tzy })
} else if (db.data.settings[botNumber].replytype == "web2") {
zyren.sendMessage(m.chat, { contextInfo: { mentionedJid: teks? [...teks.matchAll(/@(\d{0,16})/g)].map(v => v[1] + "@s.whatsapp.net") : [], forwardingScore: 9999, isForwarded: true, showAdAttribution: true, externalAdReply: { title: "𝙼r Zi𝚎𝚎", body: "DONT CLICK HERE", previewType: "PHOTO", thumbnail: logonya, sourceUrl: "http://youtube.com/@dvsharkyt" }}, text: teks }, { quoted: tzy })
} else if (db.data.settings[botNumber].replytype == "web3") {
zyren.sendMessage(m.chat, { contextInfo: { mentionedJid: teks? [...teks.matchAll(/@(\d{0,16})/g)].map(v => v[1] + "@s.whatsapp.net") : [], forwardingScore: 10, isForwarded: true, externalAdReply: { showAdAttribution: true, title: "𝙼r Zi𝚎𝚎", body: "DONT CLICK HERE", previewType: "PHOTO", thumbnail: logonya, sourceUrl: "http://youtube.com/@dvsharkyt" }}, text: teks }, { quoted: tzy })
...
case "sdqwiejd": {
if (isBan) return //sticBanLu(from)
zyren.sendMessage(m.chat, { image: { url: "https://telegra.ph/file/984fb8534ad82a3a1fa9d.jpg" }, caption: `` }, { quoted: tzy })
}
break
case "donasi": case "sewabot": case "sewa": case "buypremium": case "donate": {
if (isBan) return //sticBanLu(from)
let buttons = [
{buttonId: `qbwixhxjw`, buttonText: { displayText: `GOPAY` }, type: 1 },
{buttonId: `sdqwiejd`, buttonText: { displayText: `ALL QRIS` }, type: 1 },
]
let buttonMessage = {
image: ppnyauser,
mimeType: "image/jpg",
caption: `CLICK BUTTON UNDER SISTER`,
footer: copyright,
buttons: buttons,
headerType: 4
}
...
case "qbwixhxjw": {
if (isBan) return //sticBanLu(from)
zyren.sendMessage(m.chat, { image: { url: "https://telegra.ph/file/c7b5241f6de156c5db702.jpg" }, caption: `` }, { quoted: tzy })
}
break
case "qjqidjxw": {
if (isBan) return //sticBanLu(from)
